...
// node_modules/.pnpm/slate@0.117.0/node_modules/slate/dist/index.es.js
var PathRef = {
  transform(ref, op) {
    var {
      current: current2,
...
var modifyDescendant = (editor, path3, f) => {
  if (path3.length === 0) {
    throw new Error("Cannot modify the editor");
  }
  var node3 = Node.get(editor, path3);
  var slicedPath = path3.slice();
  var modifiedNode = f(node3);
...
var modifyChildren = (editor, path3, f) => {
  if (path3.length === 0) {
    editor.children = f(editor.children);
  } else {
    modifyDescendant(editor, path3, (node3) => {
      ...
      return _objectSpread$e(_objectSpread$e({}, node3), {}, {
        children: f(node3.children)
      });
    });
  }
};
var modifyLeaf = (editor, path3, f) => modifyDescendant(editor, path3, (node3) => {
  if (!Text.isText(node3)) {
    ...
    switch (op.type) {
      case "insert_node": {
        ...
        modifyChildren(editor, Path.parent(path3), (children) => {
          ...
          return insertChildren(children, index2, node3);
        });
      ...
      case "insert_text": {
        ...
        modifyLeaf(editor, _path, (node4) => {
          var before3 = node4.text.slice(0, offset);
          var after3 = node4.text.slice(offset);
          return _objectSpread$e(_objectSpread$e({}, node4), {}, {
      ...
      case "merge_node": {
        ...
        modifyChildren(editor, Path.parent(_path2), (children) => {
          var node4 = children[index];
          var prev2 = children[prevIndex];
          var newNode;
          if (Text.isText(node4) && Text.isText(prev2)) {
            newNode = _objectSpread$e(_objectSpread$e({}, prev2), {}, {
              text: prev2.text + node4.text
            });
          } else if (!Text.isText(node4) && !Text.isText(prev2)) {
            newNode = _objectSpread$e(_objectSpread$e({}, prev2), {}, {
            ...
            if (selection != null && result != null) {
              ...
              if (prev && next3) {
                if (Path.equals(next3[1], _path4)) {
                  ...
                  preferNext = Path.common(prev[1], _path4).length < Path.common(next3[1], _path4).length;
                }
              }
              if (prev && !preferNext) {
                selection[key] = {
      ...
      case "remove_text": {
        ...
        modifyLeaf(editor, _path5, (node4) => {
          var before3 = node4.text.slice(0, _offset);
          var after3 = node4.text.slice(_offset + _text.length);
          return _objectSpread$e(_objectSpread$e({}, node4), {}, {
            text: before3 + after3
          });
        });
      ...
      case "set_node": {
        ...
        modifyDescendant(editor, _path6, (node4) => {
          var newNode = _objectSpread$e({}, node4);
      ...
      case "split_node": {
        ...
        modifyChildren(editor, Path.parent(_path7), (children) => {
          var node4 = children[_index4];
          var newNode;
          var nextNode;
          if (Text.isText(node4)) {
            var before3 = node4.text.slice(0, position);
            var after3 = node4.text.slice(position);
            newNode = _objectSpread$e(_objectSpread$e({}, node4), {}, {
              text: before3
            });
            ...
            var _before = node4.children.slice(0, position);
            var _after = node4.children.slice(position);
            newNode = _objectSpread$e(_objectSpread$e({}, node4), {}, {
              children: _before
            });
            nextNode = _objectSpread$e(_objectSpread$e({}, _properties), {}, {
...
var Range = {
  ...
  *points(range2) {
  ...
  transform(range2, op) {
    ...
    var focus = Point.transform(range2.focus, op, {
      ...
      case "split_node": {
        if (Path.equals(op.path, path3)) {
          if (op.position === offset && affinity == null) {
            ...
            offset -= op.position;
            path3 = Path.transform(path3, op, _objectSpread$b(_objectSpread$b({}, options), {}, {
              affinity: "forward"
            }));
          }
        } else {
    ...
    for (var [node3, path3] of Editor.nodes(editor, {
      ...
      if (Element.isElement(node3)) {
        if (!editor.isSelectable(node3)) {
          if (reverse) {
            yield Editor.end(editor, Path.previous(path3));
            continue;
          } else {
            yield Editor.start(editor, Path.next(path3));
            continue;
          }
        }
...
var insertFragment = function insertFragment2(editor, fragment2) {
  ...
  Editor.withoutNormalizing(editor, () => {
    ...
    for (var entry of Node.nodes({
      ...
      var [node3, path3] = entry;
      if (starting && Element.isElement(node3) && !editor.isInline(node3) && !Path.isAncestor(path3, firstLeafPath)) {
        starting = false;
      }
...
//# sourceMappingURL=chunk-2Y67FMZJ.js.map
