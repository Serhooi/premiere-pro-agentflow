(function (global, factory) {
	...
	HighlightLayer.prototype._createHighlightRect = function (startTime, endTime) {
	  ...
	  this._highlightRect = new Rect.Rect({
	    x: startOffset,
	    y: 0,
	    width: endOffset - startOffset,
	    height: 0,
	...
	PlayheadLayer.prototype._createPlayhead = function () {
	  ...
	  this._playheadLine = new Line.Line({
	...
	PlayheadLayer.prototype._createPlayheadText = function () {
	  ...
	  self._playheadText = new Text.Text({
	    x: 0,
	    y: 0,
	...
	PlayheadLayer.prototype._start = function () {
	  ...
	  self._playheadLineAnimation = new Animation.Animation(function () {
	    var time = self._player.getCurrentTime();
	...
	function Scrollbar(waveformData, container, peaks) {
	  ...
	  this._scrollboxRect = new Rect.Rect({
	    x: this._scrollboxX,
	    y: this._offsetY,
	    width: 0,
	    height: this._height,
...
//# sourceMappingURL=peaks.ext.js.map
